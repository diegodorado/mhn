...
const Page = ({ data, path }) => {
  ...
  <Layout bodyClass="about">
    ...
    <p>La web está organizada en dos grandes secciones: 1794 -1810 y 1811-1820. La primera está dedicada al período en el que Manuel Belgrano se desempeñó como funcionario colonial e impulsó distintas reformas. La segunda refiere a la etapa que se abre tras el inicio de la Revolución de Mayo, cuando Belgrano encabezó fuerzas militares, tomó medidas políticas, se embarcó en una misión diplomática, volvió a participar en la guerra, hasta su muerte.</p>
    <p>Además, pueden encontrarse propuestas para los diferentes niveles educativos y juegos para todas las edades.</p>
    
    <p>El contenido de esta web fue desarrollado íntegramente por el equipo del <a href="https://bac.org.ar/" target="_blank">Museo Histórico Nacional</a>. Todo el patrimonio que se exhibe pertenece a las colecciones del Museo. Cuenta con el asesoramiento de la Biblioteca Argentina de Ciegos para la descripción de las imágenes y el desarrollo de la página.</p>
